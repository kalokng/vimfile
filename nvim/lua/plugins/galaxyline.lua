return {
  ...
  config = function()
	...
	local function apply_colors()
	  local sl=string.format("hi StatusLine cterm=NONE ctermfg='%s' ctermbg='%s' guibg='%s' guifg='%s'", cterms.fg, cterms.bg, colors.bg, colors.bg)
	...
	apply_colors()
	local galaxyline_colors_group = api.nvim_create_augroup("GalaxyLineColors", { clear = true })
	api.nvim_create_autocmd("ColorScheme", {
	  group = galaxyline_colors_group,
