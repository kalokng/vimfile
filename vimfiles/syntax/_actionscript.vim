...
syn keyword actionScriptRepeat				do while in
syn match actionScriptRepeat				"\<for\(\s\+each\)\?\>"
...
syn keyword actionScriptAS2 				class extends public private static interface implements package import dynamic
...
syn keyword actionScriptAS3 				final class extends public private internal static interface implements import dynamic protected
syn keyword flash9Constants				Infinity -Infinity NaN undefined
syn keyword flash9Functions				void Array Boolean decodeURI decodeURIComponent encodeURI encodeURIComponent escape int isFinite isNaN isXMLName Number Object parseFloat parseInt String trace uint unescape XML XMLList
